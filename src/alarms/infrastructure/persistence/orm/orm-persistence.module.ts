...
import { OrmFindAlarmsRepository } from "./repositories/find-alarms.respository";
import { UpsertMaterializedAlarmRepository } from "src/alarms/application/ports/upsert-materialized-alarm.repository";
import { OrmUpserMaterializedAlarmRepository } from "./repositories/upsert-materialized-alarm.respository";
...
@Module({
  ...
  providers: [
    ...
    },
    {
      ...
      useClass: OrmUpserMaterializedAlarmRepository,
    }
  ],
